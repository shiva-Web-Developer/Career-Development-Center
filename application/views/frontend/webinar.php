...
<main>
        ...
        <div class="flex flex-row space-between flex-column">
            ...
            <div class="flex flex-row space-around">
                <div class="flex flex-column flex-content-center">
                    <div id="bmi-icon">
                        <img src="<?php echo base_url() ?>assets/icon/video-conference.png">
                        <span>Webinar</span>
                    </div>
    ...
    <div class="flex flex-wrap space-around pre" style="align-items:stretch;">
        <?php
        foreach ($webinar as $row) { ?>
            <div class="disease-card pt-1 flex">
                <div class="flex flex-column item-center" >
                    <img class="card-img-top pt-2" src="<?php echo base_url() ?>assets/img/webinar/<?php echo $row['image'] ?>" id="course_img" alt="image">
                    <h6 class="card-title p-1" style="font-size:13px;"><?php echo $row['test_name']; ?></h6>
                    <a href="<?php echo base_url() ?>webinardiscreption?name=<?php echo $row['id']; ?>" class="btn btn-primary mt-1 text-light">View</a>
    ...
    function searchtest(name) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.cat').html('<div class="disease-card pt-1"><div class="flex flex-column item-center"><img class="card-img-top pt-2" src="<?php echo base_url() ?>assets/img/test/' + data.img + '" alt="image"><h6 class="card-title">' + data.name + '</h6><a href="<?php base_url() ?>viewtestdiscreption?name=' + data.name + '"  class="btn btn-primary mt-1 text-light">View</a></div></div>');
                $('.cat').show();
                $('.pre').hide();
            }
