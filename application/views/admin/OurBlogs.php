...
<?php
  if($this->session->flashdata('Blogs'))
  {
    $msg=$this->session->flashdata('Blogs');
        ...
        <div class="row"> 
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <a href="<?= base_url()?>View-Blogs" class="card-title float-lg-right">View Blogs</a>
              </div>
              <?= form_open_multipart(base_url().'Save-Blog')?>
                <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                      <!-- text input -->
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label for="image">Upload Image</label>
                            ...
                            <span>maximum upload file size(witdh:337px and Height:188px)</span>
                      </div>
                    </div>
                    <div class="col-sm-2">
                      <div class="form-group">
